...
urlpatterns = [
    ...
    path('inflows/delete/<int:pk>/', views.InflowDeleteView.as_view(), name='inflow_delete'),
    path('inflows/<int:pk>/detail/', views.InflowDetailView.as_view(), name='inflow_detail'),
    path('inflows/update/<int:pk>/', views.InflowUpdateView.as_view(), name='inflow_update'),
