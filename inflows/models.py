...
class Inflow(models.Model):
    ...
    accounting = models.ForeignKey(Accounting, on_delete=models.PROTECT, related_name='inflows')
    payment_method = models.ForeignKey(Payment, on_delete=models.PROTECT, related_name='inflows')
